...
class HeaderBar(BoxLayout):
    ...
    home_icon_url = StringProperty("https://cdn-icons-png.flaticon.com/512/1946/1946488.png")
    settings_icon_url = StringProperty("https://cdn-icons-png.flaticon.com/512/2099/2099058.png")
